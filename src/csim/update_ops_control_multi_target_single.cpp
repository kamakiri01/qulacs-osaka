...
// void multi_qubit_control_single_qubit_dense_matrix_gate_old_single(const
// UINT* control_qubit_index_list, const UINT* control_value_list, UINT
// control_qubit_index_count, UINT target_qubit_index, const CTYPE matrix[4],
// CTYPE *state, ITYPE dim); void
// multi_qubit_control_single_qubit_dense_matrix_gate_old_parallel(const UINT*
// control_qubit_index_list, const UINT* control_value_list, UINT
// control_qubit_index_count, UINT target_qubit_index, const CTYPE matrix[4],
// CTYPE *state, ITYPE dim); void
// multi_qubit_control_single_qubit_dense_matrix_gate_single(const UINT*
// control_qubit_index_list, const UINT* control_value_list, UINT
// control_qubit_index_count, UINT target_qubit_index, const CTYPE matrix[4],
// CTYPE *state, ITYPE dim); void
// multi_qubit_control_single_qubit_dense_matrix_gate_single_stack(const UINT*
// control_qubit_index_list, const UINT* control_value_list, UINT
// control_qubit_index_count, UINT target_qubit_index, const CTYPE matrix[4],
// CTYPE *state, ITYPE dim); ITYPE* create_shift_mask_list(const UINT* array,
...
void multi_qubit_control_single_qubit_dense_matrix_gate(
    ...
    // multi_qubit_control_single_qubit_dense_matrix_gate_old_single(control_qubit_index_list,
    // control_value_list, control_qubit_index_count, target_qubit_index,
    // matrix, state, dim);
    // multi_qubit_control_single_qubit_dense_matrix_gate_old_parallel(control_qubit_index_list,
    // control_value_list, control_qubit_index_count, target_qubit_index,
    // matrix, state, dim);
    // multi_qubit_control_single_qubit_dense_matrix_gate_single(control_qubit_index_list,
    // control_value_list, control_qubit_index_count, target_qubit_index,
    // matrix, state, dim);
    // multi_qubit_control_single_qubit_dense_matrix_gate_single_stack(control_qubit_index_list,
    // control_value_list,
    // control_qubit_index_count,target_qubit_index,matrix,state, dim);
    // multi_qubit_control_single_qubit_dense_matrix_gate_single_unroll(control_qubit_index_list,
    // control_value_list,
    // control_qubit_index_count,target_qubit_index,matrix,state, dim);
    // multi_qubit_control_single_qubit_dense_matrix_gate_single_simd(control_qubit_index_list,
    // control_value_list,
    // control_qubit_index_count,target_qubit_index,matrix,state, dim);
    // multi_qubit_control_single_qubit_dense_matrix_gate_parallel_simd(control_qubit_index_list,
    // control_value_list,
    // control_qubit_index_count,target_qubit_index,matrix,state, dim);
...
void multi_qubit_control_single_qubit_dense_matrix_gate_single_unroll(
    const UINT* control_qubit_index_list, const UINT* control_value_list,
    UINT control_qubit_index_count, UINT target_qubit_index,
    const CTYPE matrix[4], CTYPE* state, ITYPE dim) {
    UINT sort_array[64];
...
#ifdef _OPENMP
void multi_qubit_control_single_qubit_dense_matrix_gate_parallel_unroll(
    const UINT* control_qubit_index_list, const UINT* control_value_list,
    UINT control_qubit_index_count, UINT target_qubit_index,
    const CTYPE matrix[4], CTYPE* state, ITYPE dim) {
    UINT sort_array[64];
...
#ifdef _USE_SIMD
void multi_qubit_control_single_qubit_dense_matrix_gate_single_simd(
    const UINT* control_qubit_index_list, const UINT* control_value_list,
    UINT control_qubit_index_count, UINT target_qubit_index,
    const CTYPE matrix[4], CTYPE* state, ITYPE dim) {
    UINT sort_array[64];
...
#ifdef _OPENMP
void multi_qubit_control_single_qubit_dense_matrix_gate_parallel_simd(
    const UINT* control_qubit_index_list, const UINT* control_value_list,
    UINT control_qubit_index_count, UINT target_qubit_index,
    const CTYPE matrix[4], CTYPE* state, ITYPE dim) {
    UINT sort_array[64];
...
/*
void multi_qubit_control_single_qubit_dense_matrix_gate_old_single(const UINT*
control_qubit_index_list, const UINT* control_value_list, UINT
control_qubit_index_count, UINT target_qubit_index, const CTYPE matrix[4], CTYPE
*state, ITYPE dim) {
        // insert index list
        const UINT insert_index_list_count = control_qubit_index_count + 1;
        UINT* insert_index_list =
create_sorted_ui_list_value(control_qubit_index_list, control_qubit_index_count,
target_qubit_index);
        // target mask
        const ITYPE target_mask = 1ULL << target_qubit_index;
        // control mask
...
control_value_list, control_qubit_index_count);
        ...
        for (state_index = 0; state_index < loop_dim; ++state_index) {
                ...
                for (UINT cursor = 0; cursor < insert_index_list_count;
++cursor) { basis_c_t0 = insert_zero_to_basis_index(basis_c_t0, 1ULL <<
insert_index_list[cursor], insert_index_list[cursor]);
                }
                // flip controls
...
#ifdef _OPENMP
void multi_qubit_control_single_qubit_dense_matrix_gate_old_parallel(const UINT*
control_qubit_index_list, const UINT* control_value_list, UINT
control_qubit_index_count, UINT target_qubit_index, const CTYPE matrix[4], CTYPE
*state, ITYPE dim) {
        // insert index list
...
void multi_qubit_control_single_qubit_dense_matrix_gate_single(const UINT*
control_qubit_index_list, const UINT* control_value_list, UINT
control_qubit_index_count, UINT target_qubit_index, const CTYPE matrix[4], CTYPE
*state, ITYPE dim) { ITYPE* shift_masks =
create_shift_mask_list(control_qubit_index_list, control_qubit_index_count,
target_qubit_index); const ITYPE target_mask = 1ULL << target_qubit_index; ITYPE
control_mask = create_control_mask(control_qubit_index_list, control_value_list,
control_qubit_index_count);
        ...
        for (state_index = 0; state_index < loop_dim; ++state_index) {
                ...
                ITYPE basis_0 = state_index;
                for (UINT cursor = 0; cursor < insert_index_list_count;
++cursor) { basis_0 = (basis_0 & shift_masks[cursor]) + ((basis_0 &
(~shift_masks[cursor])) << 1);
                }
                basis_0 += control_mask;
                ITYPE basis_1 = basis_0 ^ target_mask;
...
void multi_qubit_control_single_qubit_dense_matrix_gate_single_stack(const UINT*
control_qubit_index_list, const UINT* control_value_list, UINT
control_qubit_index_count, UINT target_qubit_index, const CTYPE matrix[4], CTYPE
*state, ITYPE dim) {
        ...
        ITYPE mask_array[64];
        create_shift_mask_list_from_list_and_value_buf(control_qubit_index_list,
control_qubit_index_count, target_qubit_index, sort_array, mask_array); const
ITYPE target_mask = 1ULL << target_qubit_index; ITYPE control_mask =
create_control_mask(control_qubit_index_list, control_value_list,
control_qubit_index_count);
        ...
        for (state_index = 0; state_index < loop_dim; ++state_index) {
                ...
                ITYPE basis_0 = state_index;
                for (UINT cursor = 0; cursor < insert_index_list_count;
++cursor) { basis_0 = (basis_0 & mask_array[cursor]) + ((basis_0 &
(~mask_array[cursor])) << 1);
                }
                basis_0 += control_mask;
                ITYPE basis_1 = basis_0 + target_mask;
